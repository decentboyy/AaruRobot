...
from AaruRobot import DRAGONS as SUDO_USERS
from AaruRobot import pbot
from AaruRobot.modules.sql import forceSubscribe_sql as sql
...
@pbot.on_message(filters.text & ~filters.edited, group=1)
