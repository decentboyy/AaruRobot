...
PM_START_TEXT = """
*ʜᴇʏ,\n ᴛʜɪs ɪs 𝐀𝐀𝐑𝐔🌹𝐑𝐎𝐁𝐎𝐓 * [!](https://telegra.ph/file/e2c5edda6542fbb7bc1f8.jpg)\n\n *ɪ ᴀᴍ ᴛʜᴇ ᴍᴏsᴛ ᴘᴏᴡᴇʀꜰᴜʟ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ᴏꜰ ᴛᴇʟᴇɢʀᴀᴍ.\n  ɪ ʜᴀᴠᴇ ᴀᴡᴇsᴏᴍᴇ ꜰᴇᴀᴛᴜʀᴇs ᴀɴᴅ ɴᴏ ᴏɴᴇ ᴄᴀɴ ʙᴇᴀᴛ ᴍᴇ\nꜰᴏʀ ɢᴇᴛᴛɪɴɢ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴍʏ ᴄᴏᴍᴍᴀɴᴅs ᴄʟɪᴄᴋ ᴏɴ ᴄᴏᴍᴍᴀɴᴅs ʙᴜᴛᴛᴏɴ ᴏʀ ʜɪᴛ*​ /help
"""

buttons = [
    [
        InlineKeyboardButton(
            text="•✯ ✗ 𝐀𝐃𝐃 𝐌𝐄 𝐌𝐄𝐑𝐈 𝐉𝐀𝐀𝐍 ✯• ✗", url="https://t.me/MISS_AARU_X_ROBOT?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
            text="•❀ 𝐇𝐄𝐋𝐏 & 𝐂𝐌𝐃𝐒 ❀•", callback_data="help_back"),
    ],
    [
        InlineKeyboardButton(
            text="•✰ 𝐀𝐁𝐎𝐔𝐓 𝐌𝐄 ✰•", callback_data="fallen_"),
        InlineKeyboardButton(
            text="•✵ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐎𝐃𝐄 ✵•", callback_data=f"https://github.com/BANNA-XD143/AaruRobot"),
    ],
    [
        InlineKeyboardButton(
            text="•✩ 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 ✩•", url=f"https://t.me/LOVER_BIRDS_123"
        ),
        InlineKeyboardButton(
            text="•♡︎ 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 ♡︎•", url=f"https://t.me/BANNA_XD"
        ),
    ],
]
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text="""*ʜᴇʏ,*\n\n*ᴛʜɪs ɪs 𝐌𝐈𝐒𝐒💥𝐀𝐀𝐑𝐔-𝐑𝐎𝐁𝐎𝐓 *\n\n*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://github.com/BANNA-XD143/AaruRobot)\n\n*ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs ɪɴ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴀɴᴅ ɴᴏᴛ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ʏᴇᴛ*\n*sᴏ ɪғ ʏᴏᴜ ғᴏᴜɴᴅ ᴀɴʏ ʙᴜɢ ᴏʀ ɪғ ʏᴏᴜ ᴡᴀɴɴᴀ ʀᴇǫᴜᴇsᴛ ᴀɴʏ ғᴇᴀᴛᴜʀᴇ, ᴩʟᴇᴀsᴇ ʟᴇᴛ ᴜs ᴋɴᴏᴡ ᴀᴛ* [𝐌𝐈𝐒𝐒-𝐀𝐀𝐑𝐔𝐑𝐎𝐁𝐎𝐓](https://t.me/LOVE_BIRDS_123) *ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴩᴇʀ :* [❛-𝐌𝐑'𝐁𝐀𝐍𝐍𝐀 🚬 𝐊𝐈𝐍𝐆-𝐱𝐃 °](https://t.me/BANNA_XD)""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(f"@{SUPPORT_CHAT}", "https://telegra.ph/file/e2c5edda6542fbb7bc1f8.jpg", caption="𝐌𝐈𝐒𝐒 𝐀𝐀𝐑𝐔🥀𝐑𝐎𝐁𝐎𝐓 ɪs ᴀʟɪᴠᴇ !\n\nᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ ❛-𝐌𝐑'𝐁𝐀𝐍𝐍𝐀 🚬 𝐊𝐈𝐍𝐆-𝐱𝐃 ° 🥀")
        except Unauthorized:
            LOGGER.warning(
